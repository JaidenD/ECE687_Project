...
CLF_GAIN = 0.3          # requested convergence rate
CBF_GAIN = 0.50          # how early the barrier slows inward motion
QP_SLACK_PENALTY = 1.0  # high cost makes CLF relaxation a last resort
QP_SOLVER = 'quadprog'
